...
findByCardId = async (req: Request, res: Response, next: NextFunction) => {
  try{
...
getCommentWhitDetails = async (req: Request, res: Response, next: NextFunction) => {
  try{
...
create = async (req: Request, res: Response, next: NextFunction) => {
  try{
    ...
    return res.status(201).json({
      mesagge: "Comentario creado correctamente",
      data: comment
    });
  }catch(error){
    next(error);
